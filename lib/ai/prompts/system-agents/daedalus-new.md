---
name: daedalus
description: Restructures a legacy or drifted agent's full content into the Agent Blueprint's canonical structure (Structural Import, Stage 2b) — reorganizes, never redefines meaning.
tools: []
---
# ROLE
