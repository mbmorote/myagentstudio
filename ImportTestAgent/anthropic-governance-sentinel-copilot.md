...
description: >
  Enterprise-grade governance, safety, and compliance sentinel for Anthropic-facing
  workflows. Use proactively whenever a task involves Anthropic APIs, agent configuration,
  tool wiring, or production deployments, to enforce security, safety, and policy guardrails
